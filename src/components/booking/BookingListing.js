                ...
                <div key={booking._id} className="col-md-4">
                  <div className="card text-center">
                    ...
                    <p className="card-text booking-days">
                        {formatDate(booking.startAt)} - {formatDate(booking.endAt)} | {booking.nights}
                    </p>
                    <p className="card-text"><span>Price: </span> 
                    <span className="booking-price-value">${booking.price}</span></p>
                    <Link 
                        to={{pathname: `/rentals/${booking.rental._id}`}} 
                        className="btn btn-bwm-main">Go to Rental
                    </Link>
                    <button
